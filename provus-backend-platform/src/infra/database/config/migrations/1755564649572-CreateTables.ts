...
export class CreateTables1755564649572 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "questao" ("id" integer NOT NULL, "dificuldade" "public"."questao_dificuldade_enum" NOT NULL, "descricao" text, "exemploResposta" text, "pontuacao" integer NOT NULL, "isModelo" boolean NOT NULL, "tipo_questao" "public"."questao_tipo_questao_enum" NOT NULL, "texto_revisao" text, CONSTRAINT "PK_e9a143a9a3f4d1187df8a98e847" PRIMARY KEY ("id"))`);

...
import { PunicaoPorOcorrenciaModel } from '../punicao-por-ocorrencia';
import { ConfiguracaoNotificacaoModel } from '../configuracao-notificacao';
import { IpsPermitidosModel } from '../ips-permitidos';

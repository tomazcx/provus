            ...
            <div v-if="isFreeText" class="space-y-6">
              ...
              >
                ...
                <UButton
                  ...
                  class="mt-2"
                  >Gerar com IA</UButton
                >
              </UFormField>
              <UCheckbox
                v-model="form.aiGrading"
                name="aiGrading"
                label="Ativar correção por IA"
              />
            </div>
      ...
      >
        <div class="flex-1 flex overflow-hidden">
            ...
            >
              <div class="space-y-3">
                ...
                >
                  ...
                  <UButton
                    icon="i-heroicons-check-circle-20-solid"
                    :color="isCorrect(alt) ? 'secondary' : 'neutral'"
                    :variant="isCorrect(alt) ? 'solid' : 'ghost'"
                    @click="toggleCorrect(alt)"
                  />
          ...
          <div class="w-1/2 p-6 bg-gray-50 dark:bg-gray-800/50 overflow-y-auto">
            ...
            >
              <h4 class="text-xl font-semibold">
                {{ form.title || "Título da Questão" }}
              </h4>

              <p class="text-gray-600 dark:text-gray-300">
                {{
                  form.description || "A descrição da questão aparecerá aqui..."
                }}
              </p>
              ...
              <div v-else-if="form.alternatives.length > 0" class="space-y-2">
                ...
                >
                  ...
                  <span>{{ alt.text || `Alternativa ${alt.id}` }}</span>
                </label>
              </div>
